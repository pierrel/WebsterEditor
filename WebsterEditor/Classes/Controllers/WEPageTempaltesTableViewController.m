//
//  WEPageTempaltesTableViewController.m
//  WebsterEditor
//
...
@interface WEPageTempaltesTableViewController ()
@property (nonatomic, strong) WEPageTemplateManager *templateManager;
@end

@implementation WEPageTempaltesTableViewController
...
- (void)viewDidLoad
{
    ...
    self.templateManager = [WEPageTemplateManager sharedManager];
    
    [self.tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"Cell"];
    
    [self.navigationItem setTitle:@"Add Page With Template"];
...
{
    return self.templateManager.templates.count;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.textLabel setText:[template objectForKey:@"name"]];
