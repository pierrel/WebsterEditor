...
clojure.set.join = function() {
  var a = null, b = function(a, b) {
    ...
    if(c) {
      ...
      var h = cljs.core.nth.call(null, h, 1, null), j = clojure.set.index.call(null, c, g);
      return cljs.core.reduce.call(null, function(a, b) {
        var c = j.call(null, cljs.core.select_keys.call(null, b, g));
...
webster.elements = {};
webster.elements.all = cljs.core.sorted_map.call(null, "\ufdd0:structure", cljs.core.PersistentVector.fromArray([cljs.core.PersistentArrayMap.fromArray("\ufdd0:name container \ufdd0:tag \ufdd0:div \ufdd0:class container-fluid".split(" "), !0), cljs.core.PersistentArrayMap.fromArray(["\ufdd0:name", "row", "\ufdd0:tag", "\ufdd0:div", "\ufdd0:class", "row-fluid", "\ufdd0:only-under", cljs.core.PersistentHashSet.fromArray(["container", null], !0)], !0), cljs.core.PersistentArrayMap.fromArray(["\ufdd0:name", 
"column", "\ufdd0:tag", "\ufdd0:div", "\ufdd0:class", "span1", "\ufdd0:only-under", cljs.core.PersistentHashSet.fromArray(["row", null], !0)], !0)], !0), "\ufdd0:text", cljs.core.PersistentVector.fromArray([cljs.core.PersistentArrayMap.fromArray("\ufdd0:name paragraph \ufdd0:tag \ufdd0:p \ufdd0:class text-editable".split(" "), !0), cljs.core.PersistentArrayMap.fromArray("\ufdd0:name heading \ufdd0:tag \ufdd0:h1 \ufdd0:class text-editable".split(" "), !0)], !0), "\ufdd0:components", cljs.core.PersistentVector.fromArray([cljs.core.PersistentArrayMap.fromArray(["\ufdd0:name", 
"gallery", "\ufdd0:tag", "\ufdd0:ul", "\ufdd0:class", "thumbnails", "\ufdd0:contains", "gallery image", "\ufdd0:only-under", cljs.core.PersistentHashSet.fromArray(["row", null], !0)], !0), cljs.core.PersistentArrayMap.fromArray(["\ufdd0:name", "gallery image", "\ufdd0:tag", "\ufdd0:li", "\ufdd0:class", "span4 empty image-thumb", "\ufdd0:contains", "empty gallery image", "\ufdd0:only-under", cljs.core.PersistentHashSet.fromArray(["gallery", null], !0)], !0), cljs.core.PersistentArrayMap.fromArray(["\ufdd0:name", 
"empty gallery image", "\ufdd0:tag", "\ufdd0:div", "\ufdd0:class", "empty-decorations", "\ufdd0:contains-text", "Add Image", "\ufdd0:only-under", cljs.core.PersistentHashSet.fromArray(["gallery image", null], !0), "\ufdd0:unselectable", !0], !0)], !0));
...
webster.elements.allowed_QMARK_ = function(a, b) {
  return cljs.core.contains_QMARK_.call(null, cljs.core.set.call(null, (new cljs.core.Keyword("\ufdd0:text")).call(null, webster.elements.all)), b) ? !1 : cljs.core.seq.call(null, (new cljs.core.Keyword("\ufdd0:only-under")).call(null, a)) ? cljs.core.contains_QMARK_.call(null, (new cljs.core.Keyword("\ufdd0:only-under")).call(null, a), (new cljs.core.Keyword("\ufdd0:name")).call(null, b)) : !0
};
...
webster.dom.new_element_structure = function new_element_structure(b) {
  return cljs.core.PersistentVector.fromArray([(new cljs.core.Keyword("\ufdd0:tag")).call(null, b), webster.dom.new_element_attrs.call(null, b), cljs.core.truth_((new cljs.core.Keyword("\ufdd0:contains-text")).call(null, b)) ? (new cljs.core.Keyword("\ufdd0:contains-text")).call(null, b) : cljs.core.truth_((new cljs.core.Keyword("\ufdd0:contains")).call(null, b)) ? new_element_structure.call(null, webster.elements.get_by_name.call(null, (new cljs.core.Keyword("\ufdd0:contains")).call(null, b))) : 
  null], !0)
};
webster.dom.new_element_attrs = function(a) {
  var b = cljs.core.PersistentArrayMap.fromArray(["\ufdd0:class", [cljs.core.str(cljs.core.not.call(null, (new cljs.core.Keyword("\ufdd0:unselectable")).call(null, a)) ? "selectable" : ""), cljs.core.str(" "), cljs.core.str(cljs.core.truth_((new cljs.core.Keyword("\ufdd0:class")).call(null, a)) ? (new cljs.core.Keyword("\ufdd0:class")).call(null, a) : "")].join("")], !0);
  a = cljs.core.PersistentArrayMap.fromArray(["\ufdd0:data-type", (new cljs.core.Keyword("\ufdd0:name")).call(null, a)], !0);
...
webster.listeners.thumbnail_listener = function(a, b) {
  ...
  return webster.listeners.select_node.call(null, c, b, function(a) {
    if(cljs.core.truth_(a["delete"])) {
      var e = c.find("img");
      a = e.attr("src");
      var f = webster.dir.thumb_to_lightbox_src.call(null, e.attr("src")), e = [cljs.core.str("thumb-"), cljs.core.str(clojure.string.replace.call(null, webster.dir.file_name.call(null, e.attr("src")), "_THUMB", ""))].join(""), e = [cljs.core.str("#"), cljs.core.str(e)].join(""), e = $(e);
      b.callHandler("removingMedia", {"media-src":a});
      b.callHandler("removingMedia", {"media-src":f});
      e.remove();
      return c.remove()
    }
    var f = a["resource-path"], g = webster.dir.rel_path.call(null, a["thumb-path"]);
    a = webster.dir.rel_path.call(null, f);
    f = [cljs.core.str("thumb-"), cljs.core.str(webster.dir.file_name.call(null, f))].join("");
    e = [cljs.core.str("#"), cljs.core.str(f)].join("");
    if(cljs.core.truth_(c.hasClass("empty"))) {
      var h = c.find(".empty-decorations"), e = webster.html.compile.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0:a", cljs.core.PersistentArrayMap.fromArray(["\ufdd0:href", e, "\ufdd0:class", "thumbnail", "\ufdd0:data-toggle", "lightbox"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:img", cljs.core.PersistentArrayMap.fromArray(["\ufdd0:src", g], !0)], !0)], !0));
      a = webster.html.compile.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0:div", cljs.core.PersistentArrayMap.fromArray(["\ufdd0:id", f, "\ufdd0:class", "lightbox hide fade", "\ufdd0:tabindex", "-1", "\ufdd0:role", "dialog", "\ufdd0:aria-hidden", !0, "\ufdd0:style", "z-index: 10000;"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:div", cljs.core.PersistentArrayMap.fromArray(["\ufdd0:class", "lightbox-content"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0:img", cljs.core.PersistentArrayMap.fromArray(["\ufdd0:class", 
      ...
      var h = c.find("img"), g = h.closest("a"), j = [cljs.core.str("thumb-"), cljs.core.str(cljs.core.second.call(null, cljs.core.re_matches.call(null, /.*media\/(.*)\..*/, h.attr("src"))))].join(""), j = [cljs.core.str("#"), cljs.core.str(j)].join(""), j = $(j);
      b.callHandler("removingMedia", {"media-src":h.attr("src")});
      b.callHandler("removingMedia", {"media-src":webster.dir.thumb_to_lightbox_src.call(null, h.attr("src"))});
      h.attr("src", a);
      g.attr("href", e);
      j.attr("id", f);
