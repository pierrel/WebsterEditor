...
{var old_element_4497 = $el.find(".empty-decorations");
var new_element_4498 = webster.html.compile.call(null,cljs.core.PersistentVector.fromArray(["\uFDD0:a",cljs.core.PersistentArrayMap.fromArray(["\uFDD0:href",href,"\uFDD0:class","thumbnail","\uFDD0:data-toggle","lightbox"], true),cljs.core.PersistentVector.fromArray(["\uFDD0:img",cljs.core.PersistentArrayMap.fromArray(["\uFDD0:src",thumb_rel_path], true)], true)], true));
var lightbox_el_4499 = webster.html.compile.call(null,cljs.core.PersistentVector.fromArray(["\uFDD0:div",cljs.core.PersistentArrayMap.fromArray(["\uFDD0:id",id,"\uFDD0:class","lightbox hide fade","\uFDD0:tabindex","-1","\uFDD0:role","dialog","\uFDD0:aria-hidden",true,"\uFDD0:style","z-index: 10000;"], true),cljs.core.PersistentVector.fromArray(["\uFDD0:div",cljs.core.PersistentArrayMap.fromArray(["\uFDD0:class","lightbox-content"], true),cljs.core.PersistentVector.fromArray(["\uFDD0:img",cljs.core.PersistentArrayMap.fromArray(["\uFDD0:class","media-object","\uFDD0:src",rel_path], true)], true)], true)], true));
old_element_4497.remove();
$el.removeClass("empty");
$el.append(new_element_4498);
$(" body").append(lightbox_el_4499);
($el.find("a:last")[0]).addEventListener("click",(function (event__$1){
event__$1.preventDefault();
return true;
}));
} else
{var $thumb_image_4500 = $el.find("img");
var $link_4501 = $thumb_image_4500.closest("a");
var old_id_4502 = [cljs.core.str("thumb-"),cljs.core.str(cljs.core.second.call(null,cljs.core.re_matches.call(null,/.*media\/(.*)\..*/,$thumb_image_4500.attr("src"))))].join('');
var old_href_4503 = [cljs.core.str("#"),cljs.core.str(old_id_4502)].join('');
var $lightbox_4504 = $(old_href_4503);
bridge.callHandler("removingMedia",{"media-src":$thumb_image_4500.attr("src")});
bridge.callHandler("removingMedia",{"media-src":webster.dir.thumb_to_lightbox_src.call(null,$thumb_image_4500.attr("src"))});
$thumb_image_4500.attr("src",rel_path);
$link_4501.attr("href",href);
$lightbox_4504.attr("id",id);
$lightbox_4504.find("img").attr("src",rel_path);
}
...
var select_node__delegate = function (jnode,bridge,p__4505){
var vec__4507 = p__4505;
var callback = cljs.core.nth.call(null,vec__4507,0,null);
...
if (arguments.length > 2) {
  p__4505 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return select_node__delegate.call(this, jnode, bridge, p__4505);
};
select_node.cljs$lang$maxFixedArity = 2;
select_node.cljs$lang$applyTo = (function (arglist__4508){
var jnode = cljs.core.first(arglist__4508);
var bridge = cljs.core.first(cljs.core.next(arglist__4508));
var p__4505 = cljs.core.rest(cljs.core.next(arglist__4508));
return select_node__delegate(jnode, bridge, p__4505);
});
