...
{var old_element_5289 = $el.find(".empty-decorations");
var new_element_5290 = webster.html.compile.call(null,cljs.core.PersistentVector.fromArray(["\uFDD0:a",cljs.core.PersistentArrayMap.fromArray(["\uFDD0:href",href,"\uFDD0:class","thumbnail","\uFDD0:data-toggle","lightbox"], true),cljs.core.PersistentVector.fromArray(["\uFDD0:img",cljs.core.PersistentArrayMap.fromArray(["\uFDD0:src",thumb_rel_path], true)], true)], true));
var lightbox_el_5291 = webster.html.compile.call(null,cljs.core.PersistentVector.fromArray(["\uFDD0:div",cljs.core.PersistentArrayMap.fromArray(["\uFDD0:id",id,"\uFDD0:class","lightbox hide fade","\uFDD0:tabindex","-1","\uFDD0:role","dialog","\uFDD0:aria-hidden",true,"\uFDD0:style","z-index: 10000;"], true),cljs.core.PersistentVector.fromArray(["\uFDD0:div",cljs.core.PersistentArrayMap.fromArray(["\uFDD0:class","lightbox-content"], true),cljs.core.PersistentVector.fromArray(["\uFDD0:img",cljs.core.PersistentArrayMap.fromArray(["\uFDD0:class","media-object","\uFDD0:src",rel_path], true)], true)], true)], true));
old_element_5289.remove();
$el.removeClass("empty");
$el.append(new_element_5290);
$(" body").append(lightbox_el_5291);
($el.find("a:last")[0]).addEventListener("click",(function (event__$1){
event__$1.preventDefault();
return true;
}));
} else
{var $thumb_image_5292 = $el.find("img");
var $link_5293 = $thumb_image_5292.closest("a");
var old_id_5294 = [cljs.core.str("thumb-"),cljs.core.str(cljs.core.second.call(null,cljs.core.re_matches.call(null,/.*media\/(.*)\..*/,$thumb_image_5292.attr("src"))))].join('');
var old_href_5295 = [cljs.core.str("#"),cljs.core.str(old_id_5294)].join('');
var $lightbox_5296 = $(old_href_5295);
bridge.callHandler("removingMedia",{"media-src":$thumb_image_5292.attr("src")});
bridge.callHandler("removingMedia",{"media-src":webster.dir.thumb_to_lightbox_src.call(null,$thumb_image_5292.attr("src"))});
$thumb_image_5292.attr("src",rel_path);
$link_5293.attr("href",href);
$lightbox_5296.attr("id",id);
$lightbox_5296.find("img").attr("src",rel_path);
}
...
var select_node__delegate = function (jnode,bridge,p__5297){
var vec__5299 = p__5297;
var callback = cljs.core.nth.call(null,vec__5299,0,null);
...
if (arguments.length > 2) {
  p__5297 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return select_node__delegate.call(this, jnode, bridge, p__5297);
};
select_node.cljs$lang$maxFixedArity = 2;
select_node.cljs$lang$applyTo = (function (arglist__5300){
var jnode = cljs.core.first(arglist__5300);
var bridge = cljs.core.first(cljs.core.next(arglist__5300));
var p__5297 = cljs.core.rest(cljs.core.next(arglist__5300));
return select_node__delegate(jnode, bridge, p__5297);
});
...
var the_info = cljs.core.PersistentArrayMap.fromArray(["\uFDD0:top",pos.top,"\uFDD0:left",pos.left,"\uFDD0:width",width,"\uFDD0:height",height,"\uFDD0:tag",jnode.prop("tagName"),"\uFDD0:classes",jnode.attr("class").split(" "),"\uFDD0:addable",webster.elements.possible_under.call(null,jnode)], true);
