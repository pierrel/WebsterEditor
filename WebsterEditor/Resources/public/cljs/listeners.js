...
{var old_element_14733 = $el.find(".empty-decorations");
var new_element_14734 = webster.html.compile.call(null,cljs.core.PersistentVector.fromArray(["\uFDD0:a",cljs.core.PersistentArrayMap.fromArray(["\uFDD0:href",href,"\uFDD0:class","thumbnail","\uFDD0:data-toggle","lightbox"], true),cljs.core.PersistentVector.fromArray(["\uFDD0:img",cljs.core.PersistentArrayMap.fromArray(["\uFDD0:src",rel_path], true)], true)], true));
var lightbox_el_14735 = webster.html.compile.call(null,cljs.core.PersistentVector.fromArray(["\uFDD0:div",cljs.core.PersistentArrayMap.fromArray(["\uFDD0:id",id,"\uFDD0:class","lightbox hide fade","\uFDD0:tabindex","-1","\uFDD0:role","dialog","\uFDD0:aria-hidden",true,"\uFDD0:style","z-index: 10000;"], true),cljs.core.PersistentVector.fromArray(["\uFDD0:div",cljs.core.PersistentArrayMap.fromArray(["\uFDD0:class","lightbox-content"], true),cljs.core.PersistentVector.fromArray(["\uFDD0:img",cljs.core.PersistentArrayMap.fromArray(["\uFDD0:class","media-object","\uFDD0:src",rel_path], true)], true)], true)], true));
old_element_14733.remove();
$el.removeClass("empty");
$el.append(new_element_14734);
$(" body").append(lightbox_el_14735);
($el.find("a:last")[0]).addEventListener("click",(function (event__$1){
event__$1.preventDefault();
return true;
}));
} else
{var $thumb_image_14736 = $el.find("img");
var $link_14737 = $thumb_image_14736.closest("a");
var old_id_14738 = [cljs.core.str("thumb-"),cljs.core.str(cljs.core.second.call(null,cljs.core.re_matches.call(null,/.*media\/(.*)\..*/,$thumb_image_14736.attr("src"))))].join('');
var old_href_14739 = [cljs.core.str("#"),cljs.core.str(old_id_14738)].join('');
var $lightbox_14740 = $(old_href_14739);
$thumb_image_14736.attr("src",rel_path);
$link_14737.attr("href",href);
$lightbox_14740.attr("id",id);
$lightbox_14740.find("img").attr("src",rel_path);
}
...
var select_node__delegate = function (jnode,bridge,p__14741){
var vec__14743 = p__14741;
var callback = cljs.core.nth.call(null,vec__14743,0,null);
...
if (arguments.length > 2) {
  p__14741 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return select_node__delegate.call(this, jnode, bridge, p__14741);
};
select_node.cljs$lang$maxFixedArity = 2;
select_node.cljs$lang$applyTo = (function (arglist__14744){
var jnode = cljs.core.first(arglist__14744);
var bridge = cljs.core.first(cljs.core.next(arglist__14744));
var p__14741 = cljs.core.rest(cljs.core.next(arglist__14744));
return select_node__delegate(jnode, bridge, p__14741);
});
